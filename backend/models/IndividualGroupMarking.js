...
const individualGroupLeaderboardSchema = new mongoose.Schema(
  {
    projectId: {
...
export const IndividualGroupLeaderboard = mongoose.model(
  "IndividualGroupLeaderboard",
  individualGroupLeaderboardSchema
);
