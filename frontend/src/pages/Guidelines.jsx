            ...
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  nomination for the competition. The companies which are
                  eligible to nominate their ICT applications and products must
              ...
              <div className="mb-8">
                ...
                <ol className="list-decimal list-inside space-y-2 text-gray-600 ml-4">
                  <li>
                    The Intellectual Property Right for the product or
                    application must be owned by the company, or its
                    Intellectual Property Right is owned by the offshore parent
                    of the local company where the majority owner shareholding
                    is the local company.
                  </li>
                  <li>
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <ol className="list-decimal list-inside space-y-4 text-gray-600">
                ...
                <li>
                  ...
                  example, a postgraduate/research team of a university, or even
                  a perceivably and exceptionally innovative project by a
                  university undergraduate team, can enter its project/product
                  as an entry to one of the 5 Head Categories, and such entry if
                  relevant and eligible, also be optionally nominated to one of
                  Cross Categories, and/or optionally be nominated to one of the
                ...
                <p>
                  ...
                  <b>
                    the Cross-Category awards of RESEARCH AND DEVELOPMENT
                    PROJECT OF THE YEAR or START-UP OF THE YEAR
                  </b>{" "}
                  (for the organization which develops the application or
                  product or service of the nominated entry) – Participants will
                  ensure eligibility of the entry before nomination.
                </p>
          ...
          <section className="mb-12">
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-600 ml-4 mb-6">
                ...
                <li>
                  Additionally, for the Students' Project an Observer (the
                  project mentor or supervisor) is allowed in the team.
                </li>
                <li>
                ...
                <li>
                  Please <span className="font-semibold">READ</span> the
                  Category details before applying at the competition.
                </li>
              </ol>
              ...
              <p className="text-gray-600 mb-4">
                ...
                Nominees during the judging process (as per APICTA Judging
                Rules).
              </p>

              <p className="font-semibold text-gray-900 mb-4">
                Photographing, Video and Tape Recording during the Judging
                Process
              </p>
          ...
          <section className="mb-12">
            <div className="bg-white rounded-xl shadow-2xl p-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4 mb-6">
                ...
                <li>
                  Depending on the number of nominations, the judge or
                  coordinator would then approve the nomination for the Cross
                  category and or Technology Categories.
                </li>
                <li>
                  They may opt to have them for just 1 or both categories. It is
                  important information for all that this is not automatic and
                  is subject to management team approval.
                </li>
                <li>
            ...
            <div className="bg-white rounded-xl shadow-2xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-primary-700 transition-colors"
                >
                  Email Us
                </a>
                ...
                <a
                  href="/registration"
                  className="border-2 border-secondary-600 text-secondary-600 px-6 py-3 rounded-xl font-semibold hover:bg-gradient-to-r from-primary-600 to-secondary-600 hover:text-white transition-colors"
                >
                  Start Registration
                </a>
              </div>
